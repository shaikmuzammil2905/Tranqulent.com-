...
export default function Hero() {
  return (
    <section className="relative bg-[#03152B] text-white overflow-hidden min-h-[720px] md:min-h-[620px] lg:min-h-[900px] h-[100vh] flex items-center">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 sm:py-16 lg:py-18">
        <div className="max-w-2xl lg:max-w-xl xl:max-w-2xl">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-[44px] xl:text-[50px] font-extrabold text-white leading-[1.15] tracking-tight mb-4 sm:mb-5"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base lg:text-lg text-slate-200 font-normal leading-relaxed mb-7 sm:mb-8 max-w-xl"
          >
